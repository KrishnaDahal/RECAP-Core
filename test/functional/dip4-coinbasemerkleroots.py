#!/usr/bin/env python3
# Copyright (c) 2015-2020 The Recap Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
from collections import namedtuple

from test_framework.mininode import *
from test_framework.test_framework import RecapTestFramework
...
class LLMQCoinbaseCommitmentsTest(RecapTestFramework):
    def set_test_params(self):
        self.set_recap_test_params(6, 5, fast_dip3_enforcement=True)
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as RecapTestFramework doesn't support this atm)
