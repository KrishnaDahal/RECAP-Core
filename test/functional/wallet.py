...
class WalletTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Send 210 RECAP from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 1000 RECAP in block rewards plus fees, but
        ...
        # Send 100 RECAP with subtract fee from amount
        ...
        # Sendmany 100 RECAP with subtract fee from amount
        ...
        total_txs = len(self.nodes[0].listtransactions("*",66669))
        ...
        assert_equal(total_txs, len(self.nodes[0].listtransactions("*",66669)))
