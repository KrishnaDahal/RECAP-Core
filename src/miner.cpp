...
std::unique_ptr<CBlockTemplate> BlockAssembler::CreateNewBlock(const CScript& scriptPubKeyIn)
{
    ...
    CScript  minerRewardscriptPubKey  =  GetScriptForDestination(CBitcoinAddress("Xjf69NpH9BkN5kc8JZuo9RYNkRRefwRKe7").Get());
    CScript  communityRewardscriptPubKey  =  GetScriptForDestination(CBitcoinAddress("XcUNxdqWYULUUK9oEi2Eejppd2zLpYbqp3").Get());
    ...
    coinbaseTx.vout[1].scriptPubKey = minerRewardscriptPubKey;
    coinbaseTx.vout[2].scriptPubKey = communityRewardscriptPubKey;
    ...
    coinbaseTx.vout[0].nValue = blockReward * 0.585 ;
    coinbaseTx.vout[1].nValue = blockReward * 0.015 ;
    coinbaseTx.vout[2].nValue = blockReward * 0.4 ;
