...
BOOST_AUTO_TEST_CASE(versionbits_test)
{
    for (int i = 0; i < 64; i++) {
        ...
        // DEFINED -> STARTED -> FAILED while threshold reached
                           ...
                           .Mine(2999, TestTime(5000), 0x100).TestStarted().TestStateSinceHeight(2000) // 999 new blocks
                           .Mine(3000, TestTime(5000), 0x100).TestFailed().TestStateSinceHeight(3000) // 1 new block (so 1000 out of the past 1000 are new)
        ...
        // DEFINED -> STARTED -> LOCKEDIN at the last minute -> ACTIVE
                           ...
                           .Mine(2999, TestTime(16666), 0x200).TestStarted().TestStateSinceHeight(2000) // 49 old blocks
                           .Mine(3000, TestTime(26666), 0x200).TestLockedIn().TestStateSinceHeight(3000) // 1 old block (so 900 out of the past 1000)
