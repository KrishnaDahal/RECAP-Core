// Copyright (c) 2018-2019 The Recap Core developers
// Distributed under the MIT/X11 software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef RECAP_CRYPTO_BLS_BATCHVERIFIER_H
#define RECAP_CRYPTO_BLS_BATCHVERIFIER_H
...
#endif //RECAP_CRYPTO_BLS_BATCHVERIFIER_H
