// Copyright (c) 2019-2020 The Recap Core developers
...
static const CRPCCommand commands[] =
    { //  category              name                      actor (function)         okSafe argNames
        //  --------------------- ------------------------  -----------------------  ------ ----------
        { "recap",               "getpoolinfo",            &getpoolinfo,            true,  {} },
        { "recap",               "getprivatesendinfo",     &getprivatesendinfo,     true,  {} },
#ifdef ENABLE_WALLET
        { "recap",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
