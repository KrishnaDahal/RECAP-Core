    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  recap-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Recap in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.001 RECAP, 0.01 RECAP, 0.1 RECAP, 1 RECAP and 10 RECAP -- sort of like the paper money you use every day.</li> \
...
For more information, see the <a href=\"https://docs.recap.org/en/stable/wallets/recapcore/privatesend-instantsend.html\">PrivateSend documentation</a>."
        ));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
    }
