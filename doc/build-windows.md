...
Below are some notes on how to build Recap Core for Windows.
...
way. This will install to `c:\workspace\recap`, for example:

    make install DESTDIR=/mnt/c/workspace/recap
