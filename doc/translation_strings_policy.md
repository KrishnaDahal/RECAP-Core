...
This document provides guidelines for internationalization of the Recap Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `recap_en.ts` remains unchanged.
