...
This mechanism has been integrated into Bitcore-Node-Recap which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/recappay/insight-api-recap#web-socket-api](https://github.com/recappay/insight-api-recap#web-socket-api)
* API: [https://github.com/recappay/insight-api-recap#instantsend-transactions](https://github.com/recappay/insight-api-recap#instantsend-transactions)
